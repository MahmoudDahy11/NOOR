    ...
    children: [
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          ...
          filled: true, fillColor: const Color(0xFFF8FAF9),
...
class RoomGoalField extends StatelessWidget {
  ...
  const RoomGoalField({super.key, required this.controller,
...
class VisibilityToggleRow extends StatelessWidget {
  final bool isPublic; final VoidCallback onToggle;
  const VisibilityToggleRow({super.key, required this.isPublic,
    ...
    GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isPublic ? AppColors.primary.withValues(alpha: 0.1)
              : Colors.grey.shade100,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: isPublic
              ? AppColors.primary.withValues(alpha: 0.3) : Colors.grey.shade300),
        ),
